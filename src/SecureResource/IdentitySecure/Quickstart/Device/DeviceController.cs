...
namespace IdentitySecure.Quickstart.Device
{
    ...
    public class DeviceController : Controller
    {
        ...
        public async Task<IActionResult> Callback(DeviceAuthorizationInputModel model)
        {
            ...
            var result = await ProcessContent(model);
            if (result.HasValidationError) return View("Error");

            return View("Success");
        }

        private async Task<ProcessConsentResult> ProcessContent(DeviceAuthorizationInputModel model)
        {
            ...
            {
                // communicated outcome of consent back to identityserver
        ...
        private DeviceAuthorizationViewModel CreateConsentViewModel(string userCode, DeviceAuthorizationInputModel model, IdentityServer4.Models.DeviceFlowAuthorizationRequest request)
        {
            var vm = new DeviceAuthorizationViewModel
            {
                ...
                ClientLoginUrl = request.Client.LogoUri,
